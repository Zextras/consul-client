...
import com.zextras.consul.model.kv.Operation;
import com.zextras.consul.model.kv.TxResponse;
import com.zextras.consul.model.kv.Value;
import com.zextras.consul.model.session.SessionInfo;
import com.zextras.consul.monitoring.ClientEventCallback;
import com.zextras.consul.option.ConsistencyMode;
import com.zextras.consul.option.DeleteOptions;
import com.zextras.consul.option.ImmutablePutOptions;
import com.zextras.consul.option.ImmutableTransactionOptions;
import com.zextras.consul.option.PutOptions;
import com.zextras.consul.option.QueryOptions;
import com.zextras.consul.option.TransactionOptions;
import com.zextras.consul.util.Jackson;
...
import static com.zextras.consul.util.Strings.trimLeadingSlash;
...
public class KeyValueClient extends BaseCacheableClient {
    ...
    /**
     * Retrieves a {@link com.zextras.consul.model.kv.Value} for a specific key
    ...
    /**
     * Retrieves a {@link com.zextras.consul.model.ConsulResponse} with the
     * {@link com.zextras.consul.model.kv.Value} for a spefici key from the
     * key/value store
     * @param key The key to retrieve
    ...
    /**
     * Asynchronously retrieves a {@link com.zextras.consul.model.kv.Value} for a specific key
     * from the key/value store.
     *
     * GET /v1/kv/{key}
     *
    ...
    /**
     * Retrieves a list of {@link com.zextras.consul.model.kv.Value} objects for a specific key
     * from the key/value store.
     *
     * GET /v1/kv/{key}?recurse
     *
     * @param key The key to retrieve.
     * @return A list of zero to many {@link com.zextras.consul.model.kv.Value} objects.
     */
    ...
    /**
     * Asynchronously retrieves a list of {@link com.zextras.consul.model.kv.Value} objects for a specific key
     * from the key/value store.
     *
     * GET /v1/kv/{key}?recurse
     *

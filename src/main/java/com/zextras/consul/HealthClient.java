...
import com.zextras.consul.model.health.ServiceHealth;
...
public class HealthClient extends BaseCacheableClient {
     ...
     * {@link com.zextras.consul.model.health.HealthCheck} objects.
     */
    ...
    /**
     * Retrieves the healthchecks for a node in a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
    ...
    /**
     * Retrieves the healthchecks for a service in a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     ...
     * datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     * GET /v1/health/checks/{service}?dc={datacenter}
     *
    ...
    /**
     * Retrieves the healthchecks for a state in a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
    ...
    /**
     * Asynchronously retrieves the healthchecks for a state in a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     * GET /v1/health/state/{state}?dc={datacenter}
     *
     * @param state        The state to query.
     ...
     * {@link com.zextras.consul.option.QueryOptions}.
     * <p/>

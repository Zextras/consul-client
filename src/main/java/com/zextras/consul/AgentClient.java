...
import com.zextras.consul.model.agent.*;
...
import com.zextras.consul.option.QueryParameterOptions;
...
public class AgentClient extends BaseClient {
    ...
    /**
     * Registers the client as a service with Consul with an existing {@link com.zextras.consul.model.agent.Registration.RegCheck}
     *
     * @param port  The public facing port of the service to register with Consul.
     ...
     * @param queryOptions The Query Options to use.
     * @return A {@link com.zextras.consul.model.ConsulResponse} containing {@link FullService} object.
     */

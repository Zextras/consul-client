...
import com.zextras.consul.model.catalog.CatalogDeregistration;
import com.zextras.consul.model.catalog.CatalogNode;
import com.zextras.consul.model.catalog.CatalogRegistration;
...
public class CatalogClient extends BaseCacheableClient {
     ...
     *
     * @return A {@link com.zextras.consul.model.ConsulResponse} containing a list of
     * {@link com.zextras.consul.model.health.Node} objects.
     */
    ...
    /**
     * Retrieves all nodes for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
    ...
    /**
     * Asynchronously retrieves the nodes for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     * GET /v1/catalog/nodes?dc={datacenter}
     *
     * @param queryOptions The Query Options to use.
     ...
     *
     * @return A {@link com.zextras.consul.model.ConsulResponse} containing a map of service name to list of tags.
     */
     ...
     *
     * @return A {@link com.zextras.consul.model.ConsulResponse} containing
     * {@link com.zextras.consul.model.catalog.CatalogService} objects.
     */
    ...
    /**
     * Retrieves a single service for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
    ...
    /**
     * Asynchronously retrieves the single service for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     * GET /v1/catalog/service/{service}?dc={datacenter}
     *
     * @param queryOptions The Query Options to use.
     ...
     *
     * @return A list of matching {@link com.zextras.consul.model.catalog.CatalogService} objects.
     */
    ...
    /**
     * Retrieves a single node for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
    ...
    /**
     * Asynchronously retrieves the single node for a given datacenter with {@link com.zextras.consul.option.QueryOptions}.
     * <p/>
     * GET /v1/catalog/node/{node}?dc={datacenter}
     *
     * @param queryOptions The Query Options to use.
